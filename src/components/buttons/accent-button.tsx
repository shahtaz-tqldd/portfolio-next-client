...
const AccentButton = ({
  ...
  return (
    <motion.button
      {...animationProps}
      className={cn(
        "group relative overflow-hidden rounded-full bg-transparent py-3 px-5 text-sm transition-all w-48 text-black border border-green-300 tr",
        filled && "bg-white",
        className
      )}
    ...
    >
      <span
        className="relative z-10 font-medium text-green-300"
        style={{
          maskImage:
